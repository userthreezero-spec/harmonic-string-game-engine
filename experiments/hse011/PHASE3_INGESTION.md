# HSE-011 Phase 3: Ingestion Progress Tracker
...
| SRC-003 | GLFW Input Guide | B | 4 | DONE |
...
| SRC-013/014 | Filament PBR | B | MEDIUM |
| SRC-017 | Magnum | D | LOW |
| SRC-018 | SDL3 | B | LOW |
| SRC-020 | cppreference | B | LOW |
| SRC-024 | cereal | D | LOW |
